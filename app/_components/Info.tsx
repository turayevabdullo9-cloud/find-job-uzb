    ...
    return (
        <div>
            ...
            <div className="mt-24 grid grid-cols-2 grid-rows-2 gap-6 max-w-5xl mx-auto">
                <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm transition-shadow duration-300 hover:shadow-md hover:bg-blue-50 hover:border-blue-300">
